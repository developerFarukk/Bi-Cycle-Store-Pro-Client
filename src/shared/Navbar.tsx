...
//                                             <p className="flex h-1 w-1 items-center justify-center rounded-full bg-fuchsia-600 p-3 text-xs text-black">{cartItems.totalQuantity}</p>
//                                         </div>
...
const Navbar = () => {
    ...
    return (
        <div className="fixed w-full top-0 z-50"> {/* Added fixed positioning */}

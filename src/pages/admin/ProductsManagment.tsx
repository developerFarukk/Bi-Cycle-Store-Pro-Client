...
const ProductsManagment = () => {
    ...
    return (
        <div>
            <section className="container lg:px-16 md:px-10 px-4 mx-auto">
                <div className="sm:flex sm:items-center sm:justify-between">
                    <h2 className="text-lg font-medium text-gray-800 dark:text-white">All Bicycle Products</h2>
                </div>
                                ...
                                <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <tbody className="bg-white divide-y divide-gray-200 dark:divide-gray-700 dark:bg-gray-900">
                                        <tr>
                                            ...
                                            <td className="px-6 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">Model</td>

                                            <td className="px-6 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">Type</td>

                                            <td className="px-8 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">Price</td>

                                                ...
                                                <tr key={bi._id}>
                                                    ...
                                                    <td className="px-10 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                                        <div className="inline-flex items-center gap-x-3">
                                                            <div className="p-1 mr-1">{index + 1}</div>

                                                            <div className="flex items-center gap-x-2">
                                                                <img className="object-cover w-10 h-10 rounded-lg border-2 border-blue-100" src={bi.bicycleImage} alt={bi.name} />
                                                                <div>
                                                    ...
                                                    <td className="px-6 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{bi.model}</td>

                                                    <td className="px-6 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{bi.type}</td>

                                                    <td className="px-8 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{bi.price}</td>
                                                    <td className="px-4 py-4 text-sm text-gray-500 dark:text-gray-300 whitespace-nowrap">{bi.quantity}</td>
